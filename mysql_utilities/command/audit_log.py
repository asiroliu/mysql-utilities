...
from mysql_utilities.common.format import convert_dictionary_list, print_list
from mysql_utilities.common.server import Server
from mysql_utilities.common.tools import show_file_statistics, remote_copy
...
class AuditLog(object):
    ...
    def do_command(self):
        ...
        if (command_requires_value(command) and
                not check_command_value(command, command_value)):
