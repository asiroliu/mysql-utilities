...
from mysql_utilities.command import serverclone
from mysql_utilities.command.serverclone import user_change_as_root
from mysql_utilities.common.frm_reader import FrmReader
from mysql_utilities.common.server import Server, stop_running_server
from mysql_utilities.common.tools import (requires_encoding, encode,
...
def _spawn_server(options):
    ...
    if not quiet:
        ...
        print("# Starting the spawned server on port %s ..." % new_port, end=' ')
        sys.stdout.flush()
