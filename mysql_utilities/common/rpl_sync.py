...
from mysql_utilities.command.dbcompare import diff_objects, get_common_objects
from mysql_utilities.common.database import Database
from mysql_utilities.common.gtid import (get_last_server_gtid,
...
from mysql_utilities.common.pattern_matching import convertSQL_LIKE2REGEXP
from mysql_utilities.common.sql_transform import quote_with_backticks
...
class RPLSynchronizer(object):
    ...
    def _exist_in_obj_list(obj_name, obj_type, obj_list):
        ...
        obj_list[in]    List of objects to check. It is assumed that the list
                        ...
                        mysql_utilities.command.dbcompare.get_common_objects().
