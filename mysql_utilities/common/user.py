...
from mysql_utilities.common.grants_info import filter_grants
from mysql_utilities.exception import UtilError, UtilDBError, FormatError
from mysql_utilities.common.ip_parser import parse_connection, clean_IPv6
from mysql_utilities.common.messages import ERROR_USER_WITHOUT_PRIVILEGES
from mysql_utilities.common.pattern_matching import parse_object_name
...
def change_user_privileges(server, user_name, user_passwd, host,
    ...
    server[in]          MySQL server instances to apply changes
                        (from mysql_utilities.common.server.Server).
